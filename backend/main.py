...
app.add_middleware(CORSMiddleware, allow_origins=["https://propval-uk.vercel.app", "https://propvalue.co.uk", "https://www.propvalue.co.uk"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
